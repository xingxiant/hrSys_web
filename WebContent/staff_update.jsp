    ...
    <form role="form" method="post" action="/hrSys_web/staff_update">
        ...
        <div id="marridList">
            ...
            <div class="input-group">
                ...
                <input value=<%=marriage.getSmName() %> type="text" class="form-control inputType ins" placeholder="配偶姓名" name="smName">
            </div>
            <br>
            <div class="input-group">
                <span class="input-group-addon">配偶年龄</span>
                <input value=<%=marriage.getSmAge() %> type="text" class="form-control inputType ins" placeholder="配偶年龄" name="smAge">
            </div>
            <br>
            <div class="input-group">
                <span class="input-group-addon">配偶电话</span>
                <input value=<%=marriage.getSmPhone() %> type="text" class="form-control inputType ins" placeholder="配偶联系方式" name="smPhone">
            </div>
            <br>
            <div class="input-group">
                <span class="input-group-addon">配偶职业</span>
                <input value=<%=marriage.getSmJob() %>  type="text" class="form-control inputType ins" placeholder="配偶职业" name="smJob">
            </div>
        </div>
        <br><br>
        <div class="input-group">
